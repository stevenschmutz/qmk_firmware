...
////TODOSMS static const uint16_t ghost1_row2 =             0B0000010000100000;
////TODOSMS static const uint16_t ghost1_row3 =             0B0000100000100000;
////TODOSMS static const matrix_row_t ghost1_row3_correct = 0B0000100000000000;

////TODOSMSvoid fix_ghosting_issue(matrix_row_t current_matrix[]) {
////TODOSMS    if (current_matrix[1] == ghost1_row2 && current_matrix[2] == ghost1_row3) {
////TODOSMS        current_matrix[2] = ghost1_row3_correct;
////TODOSMS    }
////TODOSMS}
...
bool matrix_scan_custom(matrix_row_t current_matrix[]) {
    ...
    ////TODOSMSfix_ghosting_issue(current_matrix);
